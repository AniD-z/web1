  ...
  return (
    <div className="w-full max-w-6xl mx-auto p-4">
      <div className="md:flex md:items-center md:justify-between">
        ...
        <div className="md:w-[45%] mt-8 md:mt-0 text-center md:text-left">
          <AnimatePresence mode="wait">
            <motion.div
              ...
              className="inline-block px-8 py-4 border-t border-b border-gray-300 rounded-lg shadow-md bg-white"
            >
