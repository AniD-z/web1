...
const Hero = () => {
  return (
    <section id="home" className="flex md:flex-row flex-col paddingY relative">
      ...
      <motion.div
        className="flex-1 flexStart flex-col xl:px-0 paddingX relative z-10"
      ...
      >
        <div className="flex flex-row justify-between items-center w-full">
          <h1 className="flex-1 font-poppins font-semibold ss:text-[72px] text-[52px] text-white ss:leading-[100.8px] leading-[75px]">
            Threaded <br className="sm:block hidden" /> <span className="text-gradient">Sustainably </span>{" "}
          </h1>
        ...
        <p className="paragraph max-w-[470px] mt-5">
          ...
          customers' needs. We examine thread counts, fabric weights, and weave densities to ensure the exceptional
          quality of our premium cloths, which we supply to other brands.
        </p>
      </motion.div>

      <div className="flex-1 flexCenter md:my-0 my-10 relative z-10">
        <Image
      ...
      <div className="ss:hidden flexCenter relative z-10">
        <GetStarted />
      </div>
    </section>
  )
